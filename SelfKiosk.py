...
class Register:
    ...
    def __init__(self, transaction_total: int, total_items :int, discount_total: int, transaction_id: int, rewards_member: False ) -> None:
    ...
    def finalizeTransaction(self) -> None:
        ...
        self.rewards_member = input("Are you a rewards member?: ")
    ...
    def takePayment(self) -> None:
        ...
        while PaymentMethod != 'cash':
            ...
            while cash < self.transaction_total:
                cash = float(input("Not enough cash recieved, please input more cash: "))
            else:
...
def main():
    ...
    register = Register(0,0,0,0,False)
    register.addItem()
